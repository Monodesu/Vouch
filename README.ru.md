...
переносите инвентарь, привязывайте и отвязывайте аутентификаторы — всё в одном
приложении.
...
### Аккаунты
- Боковая панель с несколькими аккаунтами: **поиск**, **множественный выбор** и **перетаскивание для сортировки**
...
- Копирование имени пользователя / пароля; редактирование сохранённого пароля прямо на месте
...
### Перенос инвентаря
- Отправка обмениваемых предметов аккаунта на настроенную ссылку обмена — **все предметы** или
  **выбранные вручную** (с изображениями предметов), по одному предложению на игру
- Предустановленные игры (CS2, TF2, Dota 2, Rust, Steam) плюс **произвольный appid**
- Автоматически подтверждает итоговое предложение на мобильном устройстве
